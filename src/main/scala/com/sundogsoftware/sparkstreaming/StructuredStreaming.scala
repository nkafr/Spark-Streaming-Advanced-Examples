...
object StructuredStreaming {
   ...
   def parseDateField(field: String): Option[String] = {
      ...
      if (dateMatcher.find) {
              ...
              // group[0] returns the whole string e.g [29/Nov/2015:03:50:05 +0000]
              // group[1] returns the first portion of matched phrase - that is  29/Nov/2015:03:50:05   and that's what we want'
              // group[2] returns the second portion of matched phrase - that is  +0000
